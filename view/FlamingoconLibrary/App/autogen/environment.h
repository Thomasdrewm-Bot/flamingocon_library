...
Q_IMPORT_QML_PLUGIN(FlamingoconLibraryPlugin)
Q_IMPORT_QML_PLUGIN(FlamingoconLibraryContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/FlamingoconLibraryContent/App.qml";
